...
echo "from django.contrib.auth.models import User; User.objects.create_superuser('admin', 'admin@example.com', 'pass'); exit()" | python manage.py shell --settings=podiobooks.settings_docker

# Collect the Static Files & do other updates
